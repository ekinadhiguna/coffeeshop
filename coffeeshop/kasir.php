                ...
                <div class="modal fade" id="modalTambah">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <form method="POST" action="tambah_pemesanan.php">
                        <div class="modal-body">
                            <div class="mb-3">
                              <label class="form-label">Nama</label>
                              <input type="text" class="form-control" name="tnama" placeholder="Nama Pelanggan">
                            </div>
                        </div>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    // hitung jumlah
                    $hitungjumlah = mysqli_query($koneksi, "select * from detailpesanan where id='$id'");
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="view.php?id=<?php echo $d['id']; ?>" class="btn btn-primary">Tampilkan</a>
                        <a href="hapus_pemesanan.php?id=<?php echo $d['id']; ?>" class="btn btn-danger" onclick="return confirm('Anda yakin akan menghapus pesanan ini?')">Hapus</a>
                      </td>
                    </tr>
